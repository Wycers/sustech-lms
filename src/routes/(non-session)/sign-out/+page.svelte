	...
	<div class="lg:p-8">
		<div class="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
			<div class="flex flex-col space-y-2 text-center">
				<h1 class="text-2xl font-semibold tracking-tight">See you soon</h1>
				<!-- <p class="text-sm text-muted-foreground">Enter your email below to create your account</p> -->
			</div>
			<p class="px-8 text-center text-sm text-muted-foreground">
				You ended your LMS session, but your single sign-on (SSO) session is still active.
				While this browser window is open, you can access other applications within the SSO network
